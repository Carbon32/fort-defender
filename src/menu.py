...
class Menu():
    def __init__(self, game):
        ...
        self.button_start = ButtonText(self.game, 'Start', self.game.screen_width // 3, self.game.screen_height // 4, self.game.screen_width // 3 , self.game.screen_height // 5, self.game.screen_width // 80)
        self.button_quit = ButtonText(self.game, 'Exit', self.game.screen_width // 3, self.game.screen_height // 2, self.game.screen_width // 3, self.game.screen_height // 5, self.game.screen_width // 80)
